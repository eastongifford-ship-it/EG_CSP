...
void monthly(float income, float rent, float utilities, float groceries, float transportation) {
    float total_expenses = rent + utilities + groceries + transportation;
    float savings = income * 0.20f;
    float leftover = income - total_expenses - savings;
...
int main() {
    ...
    monthly(income, rent, utilities, groceries, transportation);
